...
*** Provide Answers In a Professional Way, make sure to add full stops, commas, question marks, and use proper grammar. Give the numeric data using commas indian numerals***
